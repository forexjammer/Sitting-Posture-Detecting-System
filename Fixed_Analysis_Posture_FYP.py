...
if __name__ == "__main__":
    ...
    while cap.isOpened():
        ...
        if keypoints.pose_landmarks:
            ...
            # take y - coordinate of P3 100px above x1
            # taking y = 0 while calculating angle between P1,P2,P3.
            cv2.circle(image, (l_shldr_x, l_shldr_y - 100), 7, yellow, -1)
            cv2.circle(image, (r_shldr_x, r_shldr_y), 7, pink, -1)
            cv2.circle(image, (l_hip_x, l_hip_y), 7, yellow, -1)

            # taking y - coordinate 100px above x1
            # take any value for y, not necessarily 100 or 200 pixels.
            ...
            # The threshold angles have been set
            if neck_inclination < 40 and torso_inclination < 10:
                ...
                cv2.line(image, (l_shldr_x, l_shldr_y), (l_shldr_x, l_shl3
                                                         2dr_y - 100), red, 4)
        ...
        # If stay in bad posture for more than 3 minutes (180s) send an alert.
        if bad_time > 180:
            sendWarning()
        # Write frames.
